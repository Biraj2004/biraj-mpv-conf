...
- **[Biraj Sarkar](https://github.com/Biraj2004)** ([@Biraj2004](https://github.com/Biraj2004)):
  ...
  - **Performance & Subtitle Architecture**: 550MB demuxer seek buffer (with 300MB back-cache), `gpu-next` tone-mapping pipeline, night mode normalization profiles, and precision anime subtitle typography.
