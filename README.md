...
- **[Biraj Sarkar](https://github.com/Biraj2004)** ([@Biraj2004](https://github.com/Biraj2004)):
  ...
  - **Performance & Subtitle Architecture**: 500MB demuxer seek buffer (with 250MB back-cache, 30s readahead, zero SSD wear), `gpu-next` tone-mapping pipeline, night mode normalization profiles, and precision anime subtitle typography.
